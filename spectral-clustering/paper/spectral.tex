...
\end{equation}
The association of $ C_1 $, namely the (weighted) edges 
inside $ C_1 $ is defined as:
\begin{equation}
...
\begin{equation}
	\minimize_{v_i \in \mathbb{R}^N, V=(v_1,v_2, \ldots , v_N) }{ \tr{ \tran{V} L V } }
	\label{eq:cut_relax}
\end{equation} 
...
\subsubsection{Normalized Association}
\label{sec:nassoc}
%[shi]
